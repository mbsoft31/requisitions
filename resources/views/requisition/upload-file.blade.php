                            ...
                            <div class="px-6 py-4" >
                                <div class="flex items-start space-x-4 px-6 py-4 border-4 border-dashed border-gray-300">
                                    ...
                                    <div class="flex flex-col flex-grow space-y-2">
                                        ...
                                        <div class="self-end">
                                            <button type="button" class="px-4 py-2 text-base rounded-lg shadow-md border border-red-400 font-semibold text-red-500 ring-red-400 hover:bg-red-50 hover:ring-2 hover:ring-red-400 hover:ring-offset-2">
                                                إختيار ملف آخر
                                            </button>
                                        </div>
                                    </div>
