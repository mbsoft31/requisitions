...
{{--                        <x-jet-application-mark class="block w-auto h-9" />--}}
                        <img src="{{asset('images/logo.png')}}" alt="logo" class="object-fill h-12 ">
                    </a>
                </div>
                        ...
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 space-x-2 text-sm font-medium leading-4 text-gray-500 transition bg-white border border-transparent rounded-md hover:text-gray-700 focus:outline-none">
                                        <span>
                                            {{ Auth::user()->name }}
                                        </span>
